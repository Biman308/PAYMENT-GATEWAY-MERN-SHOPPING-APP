          ...
          ? loadingList.map((_, index) => (
              ...
              >
                ...
                <div className="p-4 grid gap-3">
                  <h2 className="animate-pulse rounded-full bg-slate-200 py-2"></h2>
                  <p className="animate-pulse rounded-full bg-slate-200 py-2"></p>
                  <div className="flex gap-3">
                    <p className="animate-pulse rounded-full bg-slate-200 w-full py-2"></p>
                    <p className="animate-pulse rounded-full bg-slate-200 w-full py-2"></p>
                  </div>
                  <button className="animate-pulse rounded-full bg-slate-200 py-2"></button>
                </div>
              </div>
            ))
          : // SAFE MAP..
